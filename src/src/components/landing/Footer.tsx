      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-zinc-500 max-w-xs">
              Build production-ready apps through conversation. Free forever —
        ...
        <div className="mt-12 pt-8 border-t border-[#1f1f1f] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-600">
            © {new Date().getFullYear()} Smart Application Maker Platform. Free forever. No subscription.
          </p>
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="text-zinc-600 hover:text-white transition-colors" aria-label="Discord">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
